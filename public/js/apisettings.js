...
Vue.component('wicked-api', {
    ...
    <wicked-panel :open=true title="Basic Configuration" type="primary">
        ...
        <div class="form-group">
            ...
            <wicked-checkbox v-model="value.partner" label="<b>Partner API:</b> Check to mark it as a Partner API. Visitors will be able to see General Information about this API in API Catalog." />
        </div>
